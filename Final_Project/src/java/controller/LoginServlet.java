...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Account a = ad.getAccount(username, password);
        if (a == null) {
            String notifi = username + "or" + password + "not correct";
            request.setAttribute("message", notifi);
            request.getRequestDispatcher("view/Login.jsp").forward(request, response);
        } else {
            HttpSession sesson = request.getSession(true);
            sesson.setAttribute("account", a);
            ...
            Cookie cremember = new Cookie("rem", remember);
            // user check remember
            if (remember != null) {
